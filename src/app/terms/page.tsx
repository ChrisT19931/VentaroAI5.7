      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="glass-card p-8 mb-8">
          <div className="prose max-w-none">
            ...
            <div id="refund-policy" className="bg-red-900/20 border border-red-500/30 rounded-lg p-4 mb-4">
              ...
              <p className="text-gray-300">
                <strong className="text-white">ALL SALES ARE FINAL.</strong> Due to the digital nature of our products, ebooks, and coaching services, we do not offer refunds under any circumstances once a product has been purchased and delivered. This includes but is not limited to:
              </p>
              ...
              <p className="text-gray-300 mt-2">
                If you have questions about a purchase before making it, please contact our support team at <a href="mailto:chris.t@ventarosales.com" className="text-gradient hover:text-white transition-colors">chris.t@ventarosales.com</a>.
              </p>
            </div>

            <h2 className="text-2xl font-bold text-white mt-8 mb-4">Digital Products and Licensing</h2>
            <p className="mb-4 text-gray-300">
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-4">User Content</h2>
            <p className="mb-4 text-gray-300">
            ...
            <p className="mb-4 text-gray-300">
              Email: <a href="mailto:chris.t@ventarosales.com" className="text-gradient hover:text-white transition-colors">chris.t@ventarosales.com</a>
            </p>
          </div>
        </div>
