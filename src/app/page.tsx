...
export default function Home() {
  return (
    <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            ...
            <div className="md:w-1/2 relative h-64 md:h-96 w-full">
              <div className="absolute inset-0 bg-white/50 rounded-lg flex items-center justify-center shadow-lg">
                <span className="text-xl text-black font-semibold">AI Product Showcase</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card group hover:shadow-xl transition-shadow duration-300 bg-white">
              <div className="h-48 bg-gradient-to-r from-blue-600/20 to-purple-600/20 relative overflow-hidden rounded-t-lg">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-lg font-semibold text-gray-700">Premium AI E-book</div>
                  </div>
              ...
              <div className="p-6">
                ...
                200-page guide with 50+ templates, tools comparison, and exclusive bonuses.
              </p>
            ...
            <div className="card group hover:shadow-xl transition-shadow duration-300 bg-white">
              <div className="h-48 bg-gradient-to-r from-orange-500/20 to-red-500/20 relative overflow-hidden rounded-t-lg">
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-lg font-semibold text-gray-700">Premium AI Prompts</div>
                  </div>
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                30 professionally formatted prompts with customization guide and weekly updates.
              </p>
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Link href="/checkout?product=premium-ai-prompts" className="btn-primary text-sm">
                      Buy Now
                    </Link>
                  </div>
                </div>
            ...
            <div className="card group hover:shadow-xl transition-shadow duration-300 bg-white">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-700 mb-4">
                Personal 30-minute coaching session with full report to optimize your AI workflow.
              </p>
                <div className="flex justify-between items-center">
      ...
      <section className="py-16 bg-gray-200">
        <div className="container mx-auto px-4 max-w-6xl">
          <h2 className="text-3xl font-bold text-center mb-12 text-black">Why Choose Our Products</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6">
              ...
              <h3 className="text-xl font-semibold mb-2 text-black">One-Time Payment</h3>
              <p className="text-gray-700">
