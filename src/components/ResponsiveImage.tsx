...
/**
 * ResponsiveImage - An optimized image component with responsive sizing and lazy loading
 */
const ResponsiveImage = memo(function ResponsiveImage({
  ...
  useComponentOptimizer('ResponsiveImage', {
  ...
  return (
    <div 
      ...
      style={{
        ...
        overflow: 'hidden',
        width: '100%',
        height: responsive && calculatedAspectRatio ? 0 : 'auto',
        paddingBottom: responsive && calculatedAspectRatio ? `${(1 / calculatedAspectRatio) * 100}%` : undefined,
      }}
    >
      {isVisible && (
        <>
            ...
            <picture>
              ...
              <img
                ...
                style={{
                  ...
                  objectFit: responsive ? 'cover' : undefined,
                }}
              />
            </picture>
          )}
